...
<div class="syndicate-module<?php echo $params->get('$moduleclass_sfx'); ?>">
		<?php if ($params->get('sc_showpcast')) : ?>
			...
			<?php endif; ?>
				<a class="btn sc-podcastLink" style="text-align: left; padding-left:10px;padding-right:10px;" href="<?php echo htmlspecialchars($link); ?>">
		...
		<?php if ($params->get('sc_showplink')) : ?>
				<a class="btn sc-feedLink" style="text-align: left; padding-left:10px;padding-right:10px;" href="<?php echo $feedFile; ?>">
